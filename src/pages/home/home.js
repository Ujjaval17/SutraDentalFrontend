  ...
  return (
    <div className="home-main-container">
      <div className="d-flex justify-content-between align-items-center details-container">
        <div className="my-details w-100">
          <div className="profile-img mx-auto mt-5 mb-3">
          ...
          <div className="text-center details-content mx-auto">
            <h3 className="my-auto">Dr. Khushbu Singh</h3>
            <p className="my-auto">Dental Surgeon</p>
            <p className="my-auto">B.D.S</p>
            <button>Book Appointment</button>
          </div>
        </div>
        <div className="clinic-details my-5 w-100">
          <h2 className="mx-auto">Book a Clinic Appointment</h2>
          <div className="details-card p-5">
            <div className="d-flex gap-2 mb-2">
              ...
              <p className="my-auto text-start">
                Next Available at 9:00 AM, Tomorrow
              </p>
            </div>
            <div className="d-flex gap-2">
              <span>
                <ImLocation color="green" />
              </span>
              <p className="my-auto text-start">
                Shop no.04 Spruti Vihar, Near Sai siddhi chowk, ambegaon bk,
                pune 411046, Near sai siddhi chowk, Raghav Nagar, Suvarnayug
                Nagar, Pune, Maharashtra -411046
              </p>
            </div>
            <hr />
